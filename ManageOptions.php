 ...
 * This data is pulled from the 'mautic-scaffold' portion of the extras
...
class ManageOptions {
   ...
   *
   * @return \Mautic\Composer\Plugin\Scaffold\ScaffoldOptions
   ...
   *
   * @return \Mautic\Composer\Plugin\Scaffold\Interpolator
